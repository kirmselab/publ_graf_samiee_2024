...
[ opt ] = internal_parameters(opt); % If desired, user can open the "internal_parameters.m" file, and adjust the values of the rest of UFARSA's parameters
% *-* 25.11.2019: previous line changed by K. Kirmse
